...
int main(int argc, char**argv)
{
	  ...
	  if((t1!=t4)||(t2!=t3))
	    {
	      ...
	      if(t1<=t2)
		{
		  std::cout << ns0 << ' ' << ns1 << ' ' << ns2 << ' ' << (t4-t1)/INT64_C(1000000000) << ' ' << (t3-t2)/INT64_C(1000000000) << std::endl
			    << t1 << std::setw(5) << "  " << t1.getMJDInt() << "   " << std::setw(5) << t1.getDayNS()/UINT64_C(1000000000) << std::endl 
			    << t4 << std::setw(5) << "  " << t4.getMJDInt() << "   " << std::setw(5) << t4.getDayNS()/UINT64_C(1000000000) <<  "   " << (t4==t1) <<  std::endl
			    << t2 << std::setw(5) << "  " << t2.getMJDInt() << "   " << std::setw(5) << t2.getDayNS()/UINT64_C(1000000000) << std::endl 
			    << t3 << std::setw(5) << "  " << t3.getMJDInt() << "   " << std::setw(5) << t3.getDayNS()/UINT64_C(1000000000) <<  "   " << (t3==t2) << std::endl 
			    <<  std::endl;
		}
	      else
		{
...
#else
  VATime t1;
  t1.setFromMJDIntAndNS(50000, UINT64_C(500000000000));
  VATime t2;
  t2.setFromMJDIntAndNS(50005, UINT64_C(500000000001));
  ...
  std::cout << t1 << "  " << std::setw(5) << t1.getMJDInt() << "   " << std::setw(5) << t1.getDayNS()/UINT64_C(1000000000) << std::endl;
  std::cout << t2 << "  " << std::setw(5) << t2.getMJDInt() << "   " << std::setw(5) << t2.getDayNS()/UINT64_C(1000000000) << std::endl;
  std::cout << t3 << "  " << std::setw(5) << t3.getMJDInt() << "   " << std::setw(5) << t3.getDayNS()/UINT64_C(1000000000) << std::endl;
#endif
